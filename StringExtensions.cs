...
namespace CodeChief
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Terminates a string with an eelipsis ending "..." if it exceeds a specific length.
        ...
        {
            return Truncate(value, length, TruncateElipsis);
        }

        /// <summary>
        /// Terminates a string with an ending (e.g. <see cref="TruncateElipsis"/> "...") if it exceeds a specific length.
        /// Useful for building summary list items when the length could be much longer.
        /// </summary>
        /// <param name="value">The string to truncate.</param>
        /// <param name="length">
        ...
        /// <summary>
        /// Trims all lines of a string, removing tabs or white space that may have been added when reading from a config file.
        /// </summary>
