...
public class WiaDeviceInfo : DisposableObject
{
    ...
    /// Description.
    /// </summary>
    public string? Description => (from property in Properties
    ...
    /// Device type.
    /// </summary>
    public WiaDeviceType DeviceType => (WiaDeviceType)(int)_wiaDeviceInfo.Type;

    /// <summary>
    /// Device identifier.
    /// </summary>
    public string Id => _wiaDeviceInfo.DeviceID;

    /// <summary>
    /// Name.
    /// </summary>
    public string? Name => (from property in Properties
    ...
    protected override void Dispose(bool disposing)
    {
        try
        {
            ...
            if (_wiaDeviceInfo != null)
                _ = Marshal.ReleaseComObject(_wiaDeviceInfo);
        }
        finally
        {
