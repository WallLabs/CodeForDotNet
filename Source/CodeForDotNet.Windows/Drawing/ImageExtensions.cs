...
public static class ImageExtensions
{
    ...
    public static string? GetContentType(Guid formatId)
    {
        ...
        return formatId == ImageFormat.Gif.Guid
            ? GifContentType
    ...
    public static ImageFormat? GetFormat(string contentType)
    {
        ...
        if (string.Equals(contentType, WmfContentType, StringComparison.OrdinalIgnoreCase)) return ImageFormat.Wmf;
        return string.Equals(contentType, GifContentType, StringComparison.OrdinalIgnoreCase)
            ? ImageFormat.Gif
