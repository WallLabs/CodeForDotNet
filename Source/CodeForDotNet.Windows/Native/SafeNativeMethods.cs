...
internal abstract partial class SafeNativeMethods
{
    ...
    internal abstract partial class Shell32
    {
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static unsafe partial bool SHGetSpecialFolderPath(IntPtr hwndOwner, char* lpszPath, int nFolder,
    ...
    internal static unsafe partial int GetCORSystemDirectory(char* buffer, int bufferLength, ref int length);
