...
/// <summary>
/// Test implementation of the <see cref="XmlDictionary{TKey, TValue}"/> which uses a item type
/// requiring inheritance (XSI type).
/// </summary>
[Serializable]
[XmlRoot(XmlRootName, Namespace = TestConstants.XmlNamespace)]
[XmlSchemaProvider(nameof(GetSchema))]
public sealed class TestXmlDictionaryInherited : XmlDictionary<Guid, TestXmlDataInherited>
{
    /// <summary>
    ...
    /// </summary>
    public const string XmlRootName = "TestXmlDictionaryInherited";

    /// <summary>
    /// XML type name.
    /// </summary>
    public const string XmlTypeName = "TestXmlDictionaryInheritedType";
    ...
    /// </summary>
    public TestXmlDictionaryInherited()
        : base(CodeTestsMocksXsd.XmlNamespace, CodeTestsMocksXsd.XmlNamespacePrefixDefault,
              XmlEntryName, XmlKeyName, XmlValueName, true)
    {
    }
    ...
    /// </summary>
    private TestXmlDictionaryInherited(SerializationInfo info, StreamingContext context)
        : base(info, context)
    {
    }
    ...
    /// </summary>
    public static bool operator !=(TestXmlDictionaryInherited left, TestXmlDictionaryInherited right)
    {
    ...
    public override bool Equals(object? other)
    {
        ...
        if (other is not TestXmlDictionaryInherited dictionary)
            return false;
