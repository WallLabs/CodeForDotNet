...
/// <summary>
/// Test implementation of the <see cref="XmlCollection{TItem}"/> with XML serializer namespace declarations.
/// </summary>
[Serializable]
[XmlRoot(XmlRootName, Namespace = TestConstants.XmlNamespace)]
[XmlSchemaProvider(nameof(GetSchema))]
[XmlInclude(typeof(TestXmlDataNamespace))]
public class TestXmlCollectionWithNamespaces : XmlCollection<TestXmlDataNamespace>
{
    /// <summary>
    ...
    /// </summary>
    public const string XmlRootName = nameof(TestXmlCollectionWithNamespaces);

    /// <summary>
    /// XML type name.
    /// </summary>
    public const string XmlTypeName = nameof(TestXmlCollectionWithNamespaces) + "Type";

    /// <summary>
    /// Creates an empty instance.
    /// </summary>
    public TestXmlCollectionWithNamespaces()
    ...
    /// </summary>
    protected TestXmlCollectionWithNamespaces(SerializationInfo info, StreamingContext context)
        : base(info, context)
    {
    }
    ...
    /// </summary>
    public static bool operator !=(TestXmlCollectionWithNamespaces left, TestXmlCollectionWithNamespaces right)
    {
    ...
    public override bool Equals(object? other)
    {
        ...
        if (other is not TestXmlCollectionWithNamespaces collection)
            return false;
