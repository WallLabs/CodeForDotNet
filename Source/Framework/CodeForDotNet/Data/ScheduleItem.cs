...
public class ScheduleItem
{
    ...
    /// </summary>
    [XmlIgnore]
    public bool DaysSpecified => Days != DaysOfWeek.None;
    ...
    /// <summary>
    /// Date and time when the schedule ends, taking into account duration and all occurrences. Will be null when this item has <see cref="Recurrence"/> with
    /// an unlimited number of <see cref="Occurrences"/>.
    /// </summary>
    [XmlIgnore]
    public DateTimeOffset? End
    {
        get
        {
            ...
            var end = Start.AddMinutes(_duration);
    ...
    /// </summary>
    /// <remarks>
    /// Range depends on <see cref="Recurrence"/>. None = 0. Hourly = 0-23 hours (for 24+ hours use daily recurrence). Daily = 0-30 days (for 31+ days use
    ...
    /// </summary>
    [XmlIgnore]
    public bool OccurrencesSpecified => Occurrences.HasValue && Occurrences.Value > 0;
    ...
    public ScheduleItemOffset Offset
    {
        ...
        set
        {
            ...
            if (field != ScheduleItemOffset.None)
            {
    ...
    /// </summary>
    [XmlIgnore]
    public bool OffsetSpecified => Offset != ScheduleItemOffset.None;
    ...
    /// </summary>
    [XmlIgnore]
    public bool RecurrenceSpecified => Recurrence != ScheduleItemRecurrence.None;
    ...
    public override bool Equals(object? other)
    {
        ...
        if (other is not ScheduleItem scheduleItem || scheduleItem is null)
            return false;

        // Compare values
        return
            scheduleItem.TimeZoneId == TimeZoneId &&
            scheduleItem.Start == Start &&
            scheduleItem.Duration == Duration &&
            scheduleItem.Recurrence == Recurrence &&
            scheduleItem.Interval == Interval &&
    ...
    public DateTimeOffset? GetNext(DateTimeOffset date)
    {
        ...
        return eventStart > date ? eventStart.ToUniversalTime() : null;
    }

    /// <summary>
    /// Returns a string describing the schedule item, using the <see cref="CultureInfo.CurrentCulture"/>.
    /// </summary>
    ...
    /// <summary>
    /// Returns a string describing this schedule item, using the specified <see cref="CultureInfo"/>.
    /// </summary>
