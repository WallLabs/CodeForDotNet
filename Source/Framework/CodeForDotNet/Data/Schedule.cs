...
public class Schedule
{
    ...
    {
        get => field?.ToString(CultureInfo.CurrentCulture);
        set => field = StringExtensions.NullWhenEmpty(value);
    }
        ...
        do
        {
            ...
            foreach (var include in Includes)
            {
                ...
                foreach (var exclude in Excludes)
                {
                    ...
                    if (includeDate is not null && exclude.Contains(includeDate.Value, duration))
                        includeDate = null;
                }
