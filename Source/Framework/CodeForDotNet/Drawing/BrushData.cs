...
public class BrushData : ICloneable
{
    ...
    /// </summary>
    [XmlIgnore]
    public bool AngleSpecified => Angle.HasValue;
    ...
    /// </summary>
    [XmlIgnore]
    public bool EndColorSpecified => EndColor.HasValue;
    ...
    /// </summary>
    [XmlIgnore]
    public bool StartColorSpecified => StartColor.HasValue;
    ...
    /// </summary>
    [XmlIgnore]
    public bool TextureSpecified => Texture != null;
