...
public static class FileSystemExtensions
{
    ...
    /// </summary>
    public static readonly DateTime FileTimeMinValue = new(1980, 1, 1);
    ...
    public static void CopyDirectory(string sourcePath, string targetPath, EventHandler<FileSystemExtensionsProgressEventArgs>? progressHandler)
    {
    ...
    private static void CopyDirectoryRecurse(string sourcePath, string targetPath, EventHandler<FileSystemExtensionsProgressEventArgs>? progressHandler, ref int current, ref int total)
    {
        // Create the target path if it doesn't exist
        progressHandler?.Invoke(null, new FileSystemExtensionsProgressEventArgs {
