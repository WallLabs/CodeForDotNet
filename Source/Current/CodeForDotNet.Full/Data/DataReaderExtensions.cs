...
namespace CodeForDotNet.Data
{
    ...
    /// including the associated <see cref="IDataRecord"/> interface.
    /// </summary>
    public static class DataReaderExtensions
    {
        ...
        /// Value to return when the column is <see cref="System.DBNull"/>.
        ...
        /// Optional <see cref="CultureInfo"/> locale override to use when type conversion is necessary.
        ...
        #region Direct (Without Conversion)
        ...
        #region From DateTime (With Conversion)

        /// <summary>
        /// Reads a <see cref="Nullable&lt;DateTime&gt;"/> from a record by column name,
        /// with conversion to a <see cref="Nullable&lt;DateTimeOffset&gt;"/>,
        ...
        /// To convert from a source time which is UTC, an offset of <see cref="TimeSpan.Zero"/> must be used.
        /// </param>
        /// <returns>Value of the correct type or null when <see cref="System.DBNull"/>.</returns>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Reads a <see cref="Nullable&lt;DateTime&gt;"/> with conversion to a <see cref="Nullable&lt;DateTimeOffset&gt;"/>,
        /// using either a specific or system time zone.        
        /// </summary>
        /// <param name="reader"><see cref="IDataRecord"/> to read from.</param>
        /// <param name="ordinal">Column ordinal to read.</param>
        ...
        /// <summary>
        /// Reads a nullable <see cref="DateTimeOffset"/> by column name with conversion to a <see cref="DateTimeOffset"/>,
        /// using either a specific or system time zone.
        /// </summary>
        /// <param name="reader"><see cref="IDataRecord"/> to read from.</param>
        /// <param name="column">Column name to read.</param>
        ...
        /// <summary>
        /// Reads a <see cref="DateTime"/> with conversion to a <see cref="DateTimeOffset"/>,
        /// using either a specific or system time zone.
        /// </summary>
        /// <param name="reader"><see cref="IDataRecord"/> to read from.</param>
