...
namespace CodeForDotNet.Xml
{
    ...
    public enum XmlFormatOptions
    {
        ...
        /// When not set strips all white space around nodes. Use with the <see cref="Trim"/> option to also strip white space within nodes.
        ...
        /// This is independent of the <see cref="Indent"/> option which controls white space around nodes.
        /// </summary>
        Trim = 8,
