...
namespace CodeForDotNet
{
    ...
    {
        /// <summary>
        /// Truncates the accuracy of a <see cref="DateTimeOffset"/> from the default 100 nanosecond accuracy
        /// to the more common lesser accuracy of milliseconds, e.g. JSON, JavaScript and UNIX compatible.
        /// </summary>
        ...
        /// <summary>
        /// Truncates the accuracy of a <see cref="DateTime"/> from the default 100 nanosecond accuracy
        /// to the more common lesser accuracy of milliseconds, e.g. JSON, JavaScript and UNIX compatible.
        /// </summary>
        ...
        /// <summary>
        /// Converts a nullable <see cref="DateTime"/> to local time, if it is not null, otherwise does nothing.
        /// Used to eliminate <see cref="Nullable&lt;T&gt;.HasValue"/> checking code and avoid exceptions when null.
        /// </summary>
        ...
        /// <summary>
        /// Converts a nullable <see cref="DateTimeOffset"/> to local time, if it is not null, otherwise does nothing.
        /// Used to eliminate <see cref="Nullable&lt;T&gt;.HasValue"/> checking code and avoid exceptions when null.
        /// </summary>
        ...
        /// <summary>
        /// Converts a nullable <see cref="DateTime"/> to universal time, if it is not null, otherwise does nothing.
        /// Used to eliminate <see cref="Nullable&lt;T&gt;.HasValue"/> checking code and avoid exceptions when null.
        /// </summary>
        ...
        /// <summary>
        /// Converts a nullable <see cref="DateTimeOffset"/> to universal time, if it is not null, otherwise does nothing.
        /// Used to eliminate <see cref="Nullable&lt;T&gt;.HasValue"/> checking code and avoid exceptions when null.
        /// </summary>
        ...
        /// <summary>
        /// Trims to a specific accuracy. Use TimeSpan.TicksPer... constants,
        /// e.g. <see cref="TimeSpan.TicksPerSecond"/> to round to the nearest second.
        /// </summary>
