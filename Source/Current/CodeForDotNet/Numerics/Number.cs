...
namespace CodeForDotNet.Numerics
{
    ...
    public struct Number : IComparable<Number>
    {
        ...
        /// <summary>
        /// Performs a bitwise NOT on a <see cref="Number"/> value,
        ...
        /// <summary>
        /// Performs a negation of a <see cref="Number"/>,
        ...
        /// </param>
        /// <returns>
        /// New <see cref="Number" /> which is signed and has the same value.
        /// </returns>
        public Number ToSigned(bool extend)
        {
            ...
            // Copy bytes (leaving any extened byte zero)
        ...
        /// </param>
        /// <returns>
        /// New <see cref="Number" /> which is un-signed and has the same value when positive,
        ...
        public static Number Power(Number value, Number exponent)
        {
            ...
            // Perform binary exponentation (square method)
            var result = One;
