...
namespace CodeForDotNet.ComponentModel
{
    ...
    public abstract class EventCache : IEventCache
    {
        ...
        /// </summary>
        /// <remarks>
        /// Lock this object when you read or write properties of this object which must be complete
        /// as a batch before any other threads enter the section, e.g. during data load or save operations.
        /// </remarks>
        ...
        /// <summary>
        /// Called when events are suspended the first time, i.e. is not fired when nested. Fires the
        /// <see cref="EventsSuspended"/> event.
        /// </summary>
