...
public abstract class NotifyPropertyChangedBase(SynchronizationContext synchronization) : EventCache, INotifyPropertyChanged
{
    ...
    /// </summary>
    [SuppressMessage("Naming", "CA1711:Identifiers should not have incorrect suffix", Justification = "Old style event handler will be used until upgrade considered.")]
