...
namespace CodeForDotNet.ComponentModel
{
        ...
        where T : DataObject
    {
        ...
        /// </summary>
        /// <remarks>
        /// Full dispose pattern is not implemented because there is no need
        /// to un-hook events during finalization.
        /// </remarks>
        ...
        public override bool Equals(object obj)
        {
            ...
            lock (_syncRoot)
            {
                ...
                var other = obj as DataObjectCollection<T>;
                if (other is null)
                    return false;
        ...
        /// <summary>
        /// Counts the number of times the <see cref="SuspendEvents"/> method was called
        /// to decide whether events are currently suspended, when greater than zero.
        /// The value is decremented on each call to <see cref="ResumeEvents"/>.
        /// </summary>
        ...
        /// <summary>
        /// Flags that events are current enabled, and will be fired immediately.  This
        /// can be used by inheriting classes to determine whether to cache or fire events
        ...
        /// <summary>
        /// Fired when an item <see cref="DataObject.DataChanged"/> event occurs.
        /// The sender remains as the item which originated the event.
        /// </summary>
        ...
        /// when appropriate.  Implements reference counting to detect when to finally
        /// resume events, at which point the Resume event is fired.
        /// </summary>
        ...
        /// <summary>
        /// Disables all events until ResumeEvents is called.  Implements reference counting
        /// to detect when to finally resume events, increasing performance by preventing
        /// un-necessary event handling.
        /// </summary>
