...
namespace CodeForDotNet.Xml
{
    ...
    public static class XmlFullExtensions
    {
        ...
        /// Used by the <see cref="FormatXml(string,Encoding,XmlFormatOptions)"/> methods.
        /// </summary>
            ...
            get
            {
                ...
                if (_formatXmlAnyTransform == null)
                {
                        ...
                        typeof(XmlFullExtensions).Namespace + "." + FormatXmlAnyXsltFileName))
                    {
                        ...
                        var reader = XmlReader.Create(resource);
        ...
        static XslCompiledTransform _formatXmlAnyTransform;
        ...
        /// </summary>
        /// <remarks>
        /// Normally this transform would not be needed because it does nothing and the <see cref="XmlWriter"/>
        ...
        /// supports the switching of encoding at the same time as writing to an <see cref="XmlWriter"/>
        /// with specific settings.
        /// The <see cref="XmlWriter"/> used during the transform controls the indent option.
        /// </remarks>
        ...
        static XslCompiledTransform _formatXmlCopyTransform;
        ...
        static XslCompiledTransform _formatXmlTrimTransform;
        ...
        /// <summary>
        /// Overload of the <see cref="XmlReader.ReadElementContentAsDateTime()"/> which behaves similarly to the <see cref="XmlReader.ReadElementString()"/> method.
        /// Required because the <see cref="XmlReader.ReadElementContentAsDateTime()"/> is not robust enough because it does not move to the next element before reading,
        ...
        #region XmlReaderSettings Extensions

        /// <summary>
        /// Gets <see cref="XmlReaderSettings"/> configured to validate the specified schemas
        ...
        #region XmlSchemaSet Extensions
        ...
        #region XslCompiledTransform Extensions
