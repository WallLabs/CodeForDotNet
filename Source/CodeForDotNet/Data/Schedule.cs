...
namespace CodeForDotNet.Data
{
	...
	public class Schedule
	{
		...
		{
			get { return _description?.ToString(CultureInfo.CurrentCulture); }
		...
		/// </summary>
		[XmlIgnore]
		public bool ExcludesSpecified { get { return Excludes.Count > 0; } }
		...
		/// </summary>
		[XmlIgnore]
		public bool IncludesSpecified { get { return Includes.Count > 0; } }
