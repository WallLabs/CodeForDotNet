...
namespace CodeForDotNet.Numerics
{
	...
	public struct AngleVector2 : IEquatable<AngleVector2>
	{
		...
		/// </summary>					  
		public static AngleVector2 From(PointF point) => From(point.X, point.Y);
		...
		{
			return something is AngleVector2 other && Equals(other);
		}

		/// <summary>
		/// Compares this object with another of the same type.
		/// </summary>
		public bool Equals(AngleVector2 other)
		{
