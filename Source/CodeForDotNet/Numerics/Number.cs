...
namespace CodeForDotNet.Numerics
{
   ...
   public struct Number : IComparable<Number>, IEquatable<Number>
   {
      ...
      /// <summary>
      /// The internal numeric value, stored as a byte array ordered from least significant (LSB) to
      /// most significant (MSB), i.e. the LSB is at index 0.
      /// </summary>
      ...
      /// Thrown when conversion is not possible because the string value has an invalid format.
      /// </exception>
      ...
      /// </summary>
      /// <remarks>
      /// Also known as raising the <paramref name="value"/> to the specified
      /// <paramref name="exponent"/> "power". http://en.wikipedia.org/wiki/Exponentiation_by_squaring
      /// </remarks>
      ...
      /// <summary>
      /// Attempts conversion of a string to a signed or unsigned <see cref="Number"/> of the
      /// specified base.
      /// </summary>
      ...
      /// </summary>
      /// <remarks>
      /// The numeric value is stored in this byte array ordered from least significant (LSB) to most
      /// significant (MSB), i.e. the LSB is at index 0.
      /// </remarks>
      ...
      /// When true the sign will be extended when setting to a larger value.
      /// </param>
      ...
      /// </summary>
      /// <param name="extend">
      /// Set true to preserve sign by extending when converting from unsigned to signed and the most
      /// significant (sign) bit is already used by the original value.
      /// </param>
      ...
      /// </param>
      /// <returns>
      /// New <see cref="Number"/> which is unsigned and has the same value when positive, and
      /// optionally the same bit value (but different interpreted value) or zero when negative
