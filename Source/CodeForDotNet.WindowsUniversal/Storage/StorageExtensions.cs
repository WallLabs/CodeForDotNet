...
namespace CodeForDotNet.WindowsUniversal.Storage
{
    ...
    {
        #region IStorageFolder Extensions
        ...
        /// <summary>
        /// Calls the <see cref="IStorageFolder.CreateFolderAsync(string)"/> method synchronously
        ...
        /// A better alternative to <see cref="IStorageFolder.GetFileAsync"/> which throws an exception when not found.
        /// </summary>
        ...
        /// A better alternative to <see cref="IStorageFolder.GetFolderAsync"/> which throws an exception when not found.
        /// </summary>
        /// <param name="parentFolder">Folder to query, usually specified via extension.</param>
