...
namespace CodeForDotNet.WindowsUniversal.UI
{
   ...
   public abstract class ApplicationBase : Application
   {
      ...
      /// <summary>
      /// Currently loaded pages, managed by this application, e.g. their state is saved and restored
      ...
      /// be used when the application is launched to open a specific file, to display search
      ...
      protected override void OnLaunched(LaunchActivatedEventArgs @event)
      {
         ...
         // When the navigation stack isn't restored navigate to the first page, configuring the new
