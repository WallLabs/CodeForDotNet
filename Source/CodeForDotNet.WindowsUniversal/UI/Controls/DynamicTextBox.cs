...
{
    /// <summary>
    /// Enhanced <see cref="TextBox"/> control supporting multiple key-down tracking
    ...
    public class DynamicTextBox : TextBox
    {
        ...
        /// Set during the <see cref="OnKeyDown"/> even handler, after <see cref="OnBeforeKeyDown"/> but before
        ...
        {
            get { return (Control)GetValue(GroupNextProperty); }
        ...
        {
            get { return (Control)GetValue(GroupPreviousProperty); }
        ...
        {
            get { return (Control)GetValue(GroupDownProperty); }
        ...
        {
            get { return (Control)GetValue(GroupUpProperty); }
        ...
        public char? PadChar
        {
            get { return (char?)GetValue(PadCharProperty); }
        ...
        /// Requires <see cref="DirectInput"/> to be enabled.
        /// </summary>
        ...
        /// the control has <see cref="TextBox.IsReadOnly"/> set, e.g. to blocking any soft keyboards from popping up.
        /// </summary>
        ...
        private void OnTextChanged(object sender, TextChangedEventArgs args)
        {
            ...
            else if (selectionStart > textLength) selectionStart = textLength;
        ...
        /// <summary>
        /// Called after the <see cref="UIElement.KeyDown" /> event is processed.
        /// The key press was blocked when <see cref="KeyRoutedEventArgs.Handled"/> is true.
        /// </summary>
        ...
        /// <summary>
        /// Called before the <see cref="UIElement.KeyUp" /> event is processed.
        /// Set <see cref="KeyRoutedEventArgs.Handled"/> true to block the key release from being processed by the base control.
        /// Use the <see cref="KeyRoutedEventArgs.Key"/> to examine the released key, the <see cref="KeysDown"/> collection
        ...
        /// <summary>
        /// Called after the <see cref="UIElement.KeyUp" /> event is processed.
        /// The key release processing was blocked when <see cref="KeyRoutedEventArgs.Handled"/> is true.
        /// </summary>
        ...
        /// <summary>
        /// Moves to the <see cref="GroupPrevious"/> control if specified.
        /// When the next control is a <see cref="TextBox"/> also selects the
        ...
        /// <summary>
        /// Moves to the <see cref="GroupNext"/> control if specified.
        /// When the next control is a <see cref="TextBox"/> also selects the
        /// next logical character from which to continue input.
        /// </summary>
        /// <returns>True when a move occurred.</returns>
        ...
        /// <summary>
        /// Moves to the <see cref="GroupUp"/> control if specified.
        /// When the next control is a <see cref="TextBox"/> also selects the
        /// next logical character from which to continue input.
        /// </summary>
        /// <returns>True when a move occurred.</returns>
        ...
        /// <summary>
        /// Moves to the <see cref="GroupDown"/> control if specified.
        /// When the next control is a <see cref="TextBox"/> also selects the
        /// next logical character from which to continue input.
        /// </summary>
        /// <returns>True when a move occurred.</returns>
