...
namespace CodeForDotNet.WindowsUniversal.UI.Controls
{
   ...
   public class DynamicTextBox : TextBox
   {
      ...
      /// <summary>
      /// Enables direct handling of input from key press events, allowing input to be accepted even
      /// when the control has <see cref="TextBox.IsReadOnly"/> set, e.g. to blocking any soft
      ...
      /// <summary>
      /// Sets the next control downwards in an input group, to which the focus will be switched when
      /// moving down in this text box.
      /// </summary>
      ...
      /// <summary>
      /// Sets the previous control upwards an input group, to which the focus will be switched when
      /// moving up in this text box.
      /// </summary>
      ...
      /// <see cref="OnBeforeKeyDown"/> but before <see cref="OnAfterKeyDown"/> to supporting repeat detection.
      /// </summary>
      ...
      /// key press, the <see cref="KeysDown"/> collection does not contain the current key unless it
      /// was previously pressed to support repeat detection. This class implements grouped control
      /// navigation in this method. If you override this method and do not call it this
      ...
      /// <see cref="KeyRoutedEventArgs.Handled"/> true to block the key release from being processed
      /// by the base control. Use the <see cref="KeyRoutedEventArgs.Key"/> to examine the released
      /// key, the <see cref="KeysDown"/> collection is the state before processing this event so
      /// still contains the released key.
      /// </summary>
      ...
      /// <summary>
      /// Enforces selection rules based on current/maximum length and trying over to next control in
      /// a group.
      /// </summary>
